...
df <- read_excel("data/WORLD-MACHE_Gender_6.8.15.xls", sheet = 1, col_name = TRUE)
...
barplot(unlist(m55[2, -1]))       # raise error
...
barplot(unlist(m55[2, -1]), space = 0, border = NA, xaxt = "n", yaxt = "n", main = m55[2, 1], line = -4, cex.main = 5, ylim = c(0, 5))
...
```{r}
# plot the 1st row
barplot(unlist(m55[1, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[1, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
barplot(unlist(m55[2, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[2, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
barplot(unlist(m55[3, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[3, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
barplot(unlist(m55[4, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[4, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
barplot(unlist(m55[5, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[5, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
barplot(unlist(m55[6, -1]), space = 0, border =
        NA, xaxt = "n", yaxt = "n", main = m55[6, 
        1], line = -4, cex.main = 5, ylim = c(0, 
        5))
...
for (i in 1:10){
    barplot(unlist(m05[i, -1]), space = 0, border     = NA, xaxt = "n", yaxt = "n", main = m05[i, 
    1], line = -4, cex.main = 5, ylim = c(0, 5))
...
for (i in 1:nrow(m55)){
    barplot(unlist(m55[i, -1]), space = 0, border     = NA, xaxt = "n", yaxt = "n", main = m55[i, 
    1], line = -3, cex.main = 3, ylim = c(0, 5))
}
